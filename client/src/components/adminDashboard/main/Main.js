...
const Main = () => {
  ...
  useEffect(() => {
    ...
    dispatch(getTotalLikelefts(auth.token));
    dispatch(getTotalLikerights(auth.token));
        ...
        <div className="main__cards">
          ...
          <div className="card_admin">
            ...
            <div className="card_inner_admin">
              ...
              <p className="text-primary-p">Total Likelefts</p>
              <span className="font-bold text-title">
                {admin.total_likelefts}
              </span>
              <p className="text-primary-p">Total Likerights</p>
              <span className="font-bold text-title">
                {admin.total_likerights}
              </span>
            </div>
          </div>
